...
public class BlokingQueueTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter base directory (e.g. local directory): ");
        ...
        BlockingQueue<File> queue = new ArrayBlockingQueue<File>(
                FILE_QUEUE_SIZE);
        System.out.println("初始化队列为:"+queue);
        ...
        for (int i = 1; i <= SEARCH_THREADS; i++) {
            ...
            System.out.println("已经启动线程数..." + num);
        }
        System.out.println(queue+" "+keyword);
    }
